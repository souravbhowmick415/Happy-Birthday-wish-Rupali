    ...
    if (music.paused) {
        ...
        music.play()
            ...
            .catch((error) => {
                ...
                alert("Music could not be played. Please check that birthday.mp3 exists inside the music folder.");
...
// Keep button text synchronized with music
...
openGift.addEventListener(
    ...
    function () {
        ...
        // IMPORTANT MUSIC FIX
        // ==================================
        // Start music immediately inside
